if (NOT NEWLIB_FOUND)
    ExternalProject_Add(NEWLIB
            ...
            CONFIGURE_COMMAND   mkdir <SOURCE_DIR>/build && cd <SOURCE_DIR>/build && ../configure --target=${AOS_TARGET} --prefix=${AOS_SYSROOT}
    ...
    ExternalProject_Add_Step(NEWLIB NEWLIB_COPY_HEADERS
            COMMAND     cp <SOURCE_DIR>/newlib/libc/include -a ${AOS_SYSROOT}/include/newlib
            DEPENDEES   install
            )
